        ...
        <div className="we_work_on">
          <div className="we_work_on_left">
            ...
            {researchList.map((item, index) => (
              <div key={index} className="we_work_on_content">
