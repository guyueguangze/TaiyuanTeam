  ...
  const PublicationsList = [
    {
      ...
      place: "ASPLOS 2024",
      author:
        "谭思危, 张涵禹, 余加, 郎聪亮, 赵新奎, 陈明帅, 梁云, 卢丽强, 尹建伟",
      Abstract:
...

    {
      ...
      place: "HPCA 2023",
      author: "谭思危, 于茗谦, Andre Python, 尚永衡, 李婷婷, 卢丽强, 尹建伟",
    ...
    },
    {
      ...
      author:
        "谭思危, 郎聪亮, Liang Xiang, 王沭迪, 贾星辉, Ziqi Tan, 李婷婷, Jieming Yin, 尚永衡, Andre Python, 卢丽强∗, 尹建伟",
      content:
  ...
  return (
    <div className={styles.root}>
      ...
      <div className="publication_container">
        <div className="publication_title big_title">科研成果</div>
        ...
        <div className="Patents">
          <div className="Patents_title Publications_title taiyuanColor">专利</div>
          <div className="Patents_content">
            {PatentsList.map((item, index) => (
              <div key={index} className="Patents_item Publications_item">
                <div className="Patents_item_title Publications_item_title">{item.title}</div>
        ...
        <div className="Copyright ">
          <div className="Copyright_title Publications_title taiyuanColor">软件著作权</div>
          <div className="Copyright_contetn">
            {CopyrightList.map((item, index) => (
              <div key={index} className="Copyright_item Publications_item">
                <div className="Copyright_item_title Publications_item_title">{item.title}</div>
